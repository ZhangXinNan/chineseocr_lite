...
if __name__ == "__main__":
    import os
    ocr = OcrHandle()
    # img_path = r'C:\gitlab\card_ocr_service\test\imgs\Philippine\5109-4160-4695-3642.png'
    img_path = r'C:\gitlab\card_ocr_service\test\imgs\Mexico\162_front.jpeg'
    print(os.path.isfile(img_path))
    img = cv2.imread(img_path, cv2.IMREAD_COLOR)
    print(img_path, img.shape)
    result = ocr.text_predict(img, 1024)
    print(result)
